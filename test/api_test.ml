...
let call_api_apply_rule_full_response () =
    let body_as_string = "{\"ruleRequest\":{\"rule\": \"par\", \"formulaPosition\":0}, \"sequent\": {\"hyp\": [],\"cons\": [{\"type\": \"par\", \"value1\":{\"type\": \"litteral\", \"value\":\"a\"},\"value2\":{\"type\": \"litteral\", \"value\":\"a\"}}]}}" in
...
let call_api_is_proof_complete_full_response () =
    let body_as_string = "{\"sequent\":{\"hyp\": [],\"cons\": [{\"type\":\"litteral\",\"value\":\"a\"},{\"type\":\"orthogonal\",\"value\":{\"type\":\"litteral\",\"value\":\"a\"}}]},\"appliedRule\":{\"ruleRequest\":{\"rule\":\"axiom\"},\"premises\":[]}}" in
